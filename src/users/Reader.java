...
public class Reader extends User {
	...
	* @param userId User's unique Id, defined by the system
	 ...
	 */
	public Reader(int userId, String userFirstName, String userLastName, String username, String password, List<String> userCategories) {
		super(userId, userFirstName, userLastName, username, password, "READER", userCategories);
	}
}
